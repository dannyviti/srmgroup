...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'loss_report.responder_info'
        db.alter_column(u'customer_portal_loss_report', 'responder_info_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['customer_portal.responder_information']))

        # Changing field 'loss_report.organization'
        db.alter_column(u'customer_portal_loss_report', 'organization_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.Group']))

    def backwards(self, orm):

        # Changing field 'loss_report.responder_info'
        db.alter_column(u'customer_portal_loss_report', 'responder_info_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['customer_portal.responder_information'], null=True))

        # Changing field 'loss_report.organization'
        db.alter_column(u'customer_portal_loss_report', 'organization_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group'], null=True))
    ...
    models = {
        ...
        u'customer_portal.loss_report': {
            ...
            'organization': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.Group']", 'blank': 'True'}),
            ...
            'responder_info': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['customer_portal.responder_information']", 'blank': 'True'}),
