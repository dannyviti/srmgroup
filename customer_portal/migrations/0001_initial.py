...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Files'
        db.create_table(u'customer_portal_files', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('file_inc', self.gf('django.db.models.fields.TextField')()),
        ...
        db.send_create_signal(u'customer_portal', ['Files'])

        # Adding model 'responder_information'
        db.create_table(u'customer_portal_responder_information', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('contractor_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ...
        db.send_create_signal(u'customer_portal', ['responder_information'])

        # Adding model 'loss_report'
        db.create_table(u'customer_portal_loss_report', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')()),
            ('srm_id', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('reported_by', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('o_call_back', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('c_call_back', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('f_call_back', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('organization', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group'], null=True, blank=True)),
            ('loss_loc', self.gf('django.db.models.fields.CharField')(max_length=400)),
            ('site_cont', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('material_dis', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('material_dis_qt', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('pervious', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('impervious', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('surface_water', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('storm_drain', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('msds_sec', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('dot_reprtbl', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('c_claim_no', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('c_freight_no', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('c_adjuster', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('c_tractor_no', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('c_trailer_no', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('c_driver', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('c_driver_no', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('police_fire_recovery', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('agency_state', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('agency_state_no', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('agency_epa', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('agency_epa_no', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('agency_nrc', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('agency_nrc_no', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('responder_info', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['customer_portal.responder_information'], null=True, blank=True)),
            ('initial_corrective_actions', self.gf('django.db.models.fields.TextField')()),
            ('intial_reserve', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('ir_given_to', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('ir_date', self.gf('django.db.models.fields.DateField')()),
            ('adjusted_reserve', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('ar_given_to', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('ar_date', self.gf('django.db.models.fields.DateField')()),
            ('project_scope_timeline', self.gf('django.db.models.fields.TextField')()),
            ('site_work_completed_comments', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'customer_portal', ['loss_report'])


    def backwards(self, orm):
        # Deleting model 'Files'
        db.delete_table(u'customer_portal_files')

        # Deleting model 'responder_information'
        db.delete_table(u'customer_portal_responder_information')

        # Deleting model 'loss_report'
        db.delete_table(u'customer_portal_loss_report')
